...
class CoffeeOrder
{
    static void Main()
    {
        Console.WriteLine("Enter Coffee Name:");
        ...
        Console.WriteLine("Enter Sugar Portions:");
        int sugarPortions = Convert.ToInt32(Console.ReadLine());

        Console.WriteLine("Enter Extra Topping Price:");
        double extraToppingPrice = Convert.ToDouble(Console.ReadLine());

        Console.WriteLine("Enter First Letter of Size:");
        char sizeLetter = Convert.ToChar(Console.ReadLine());

        Console.WriteLine("Is Takeaway? (true/false):");
